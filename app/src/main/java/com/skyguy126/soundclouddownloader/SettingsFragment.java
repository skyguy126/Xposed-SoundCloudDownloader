...
public class SettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        showLauncherIconCheckbox.setOnPreferenceClickListener(preference -> {
        ...
        saveLocationSpinner.setOnPreferenceChangeListener((preference, newValue) -> {
        ...
        sourceButton.setOnPreferenceClickListener(preference -> {
